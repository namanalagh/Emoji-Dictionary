...
class EmojiTableViewController: UITableViewController {
    ...
    var emojis: [Emoji] = [
       ...
       Emoji(symbol: "💀", name: "Skull", description: "A human skull.", usage: "when you forgor"),
       Emoji(symbol: "🗿", name: "Moai", description: "An ancient Moai statue.", usage: "bruh moments"),
       Emoji(symbol: "😭", name: "Crying Face", description: "A face with tears running down.", usage: "sad or funny"),
       Emoji(symbol: "👍", name: "Thumbs Up", description: "A hand with a thumbs up", usage: "okay")
    ] 
